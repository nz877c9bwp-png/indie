...
- `.brand-word` — one `music-mark` → `accent-mark` sweep (100deg) clipped to the text across the whole word. Each word is a `.bw-group`; groups sit 0.18em apart, wider than any capital-to-tail join.
