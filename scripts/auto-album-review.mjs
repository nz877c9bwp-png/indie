...
2. 네가 알고 있는 이 앨범의 실제 평가/평판/분위기를 바탕으로, 위 기존 글들과 비슷한 톤(반말/구어체, 개인적인 감상, 전문 평론가 말투 아님, 그렇다고 일부러 허접하게 쓰지도 않음)으로 리뷰를 써라. 확신 없는 곡 제목이나 가사는 절대 지어내지/인용하지 말고, 실제 리뷰 문구를 베끼지도 마라. 길이/평점/제목 스타일은 매번 다르게.
